    ...
    return (
      <Content>
        ...
        <div className="text-center">
          <h3 style={this.styles.ribbon}> Mexican Series </h3>
          <div className="row">
        ...
        <div className="text-center">
          <h3 style={this.styles.ribbon}> Italian Series </h3>
          <div className="row">
        ...
        <div className="text-center">
          <h3 style={this.styles.ribbon}> Thai Series </h3>
          <div className="row">
            <div className="col-md-12">
        ...
        <div className="text-center">
          <h3 style={this.styles.ribbon}>Explorer</h3>
          <div className="row">
