	...
	var Article = (function (_React$Component) {
	  ...
	  function Article(p) {
	    ...
	    if (!_this.props.loadStatic && _ExecutionEnvironment2.default.canUseDOM) {
	      ...
	      fetch('/articles.json?id=' + _this.props.params.id).then(function (data) {
	        return data.json();
	      }).then(function (data) {
	  ...
	  _createClass(Article, [{
	    ...
	    value: function fillIn(layout, data) {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_Related2.default, { _for: this.props.params ? this.props.params.id : null })
	      );
	    }
	  }, {
	    key: 'render',
